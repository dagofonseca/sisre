...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { televisor: @salon.televisor, videoBeam: @salon.videoBeam } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { televisor: @salon.televisor, videoBeam: @salon.videoBeam } }
