...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { computadores: @salon.computadores, proyecto: @salon.proyecto } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { computadores: @salon.computadores, proyecto: @salon.proyecto } }
