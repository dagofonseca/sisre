...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { fecha: @reserva.fecha, identificador: @reserva.identificador, numUsu: @reserva.numUsu } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { fecha: @reserva.fecha, identificador: @reserva.identificador, numUsu: @reserva.numUsu } }
